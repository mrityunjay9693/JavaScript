/**
 * let: let is a keyword which is used for declaration of a variable.
        It was introduced with ECMAScript 6 to provide an alternate to var keyword(also used for declaration of variable in JS).
        let declares variable with block-scope. 
        Variable declared with let keyword are limited to the block, or function or statements or expression 
